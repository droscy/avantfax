...
$LANG['NOTIFY_REQUEUE'] = "Уведомлять о запросе";
...
$LANG['LOGIN_ALT_FAILED'] = "Вход %s не удался .  Попросите Вашего администратора подтвердить учетную запись AvantFAX.";
...
$LANG['SELECT_ALL_FAXES'] = "Выбрать все факсы";
$LANG['FAXES_PER_PAGE']  = "факсов на страницу";
$LANG['INBOX_SHOW'] = "Входящие - показать";
$LANG['ARCHIVE_SHOW'] = "Архив - показать";
...
$LANG['EMAIL_CCRECIPIENTS'] = "Получатели email (СС)";
$LANG['EMAIL_BCCRECIPIENTS'] = "Получатели email (BСС)";
...
$LANG['COVER_EXISTS'] = "Титульная страница уже существует";
$LANG['COVER_NOT_CREATED'] = "Титульная страница не была создана";
$LANG['NO_COVERS_CONFIGURED'] = "Нет настроенных титульных страниц";
$LANG['COVER_DOESNT_EXIST'] = "Титульная страница %s не существует";
...
$LANG['ADMIN_COVER_CREATED'] = "Титульная страница создана";
$LANG['ADMIN_COVER_DELETED'] = "Титульная страница удалена";
$LANG['ADMIN_COVER_UPDATED'] = "Титульная страница обновлена";
...
$LANG['COVER_FILE'] = "Имя файла";
$LANG['COVER_TITLE'] = "Имя титульной страницы";
$LANG['SELECT_COVERPAGE'] = "Выберите титульный лист";

$LANG['SELECT_AUDIO'] = "Выберите аудиофайл";
...
$LANG['MISSING_FILE_NAME'] = "Вы должны ввести имя файла";
$LANG['MISSING_TITLE_NAME'] = "Вы должны ввести заголовок";
...
$LANG['ADMIN_CONFCOVERS'] = "Титульные страницы";
...
$LANG['DYNCONF_CALLID'] = "ID абонента";
